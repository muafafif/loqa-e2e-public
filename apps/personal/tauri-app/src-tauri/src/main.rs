...
fn find_backend_binary() -> Option<std::path::PathBuf> {
    ...
    let candidates = [
        ...
        app_dir.join("loqa-home-backend.exe"),
        app_dir.join("loqa-home-backend"),
        // macOS .app bundle: exe is at Contents/MacOS/, resources at Contents/Resources/
        app_dir.join("../Resources/loqa-home-backend"),
...
fn start_backend() -> Option<Child> {
    ...
    // DATA_DIR and MODELS_DIR are set by run.py to ~/LOQA/personal/data and
