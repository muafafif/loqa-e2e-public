import type {
  ...
  TransactionType, PLMonthRow, FinancialGoal,
} from "@/types";

const BASE = "http://localhost:8000/api/finance";
...
export async function createGoal(
  body: Omit<FinancialGoal, "id" | "created_at" | "updated_at">
