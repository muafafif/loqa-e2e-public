...
from app.api import chat, knowledge, models, settings, metrics, conversations, lock, finance, inventory, orders, notes, projects, license
...
from app.services.project_service import init_db as init_projects_db
...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["http://localhost:3002", "tauri://localhost"],
