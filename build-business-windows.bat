@echo off
:: Build LOQA Work for Windows
:: Usage:
::   build-business-windows.bat          (auto-detect GPU)
::   build-business-windows.bat --cuda   (force CUDA)
::   build-business-windows.bat --cpu    (force CPU only)
